<template>
  <section class="bg-base-100 py-20 px-6 lg:px-20 xl:px-32 relative overflow-hidden" id="programs" data-aos="fade-up">
    ...
    <div class="flex flex-row gap-8 mx-auto items-stretch 2xl:justify-center overflow-x-auto snap-x snap-mandatory px-4 lg:px-0 scrollbar-hide pb-12 pt-10">
      ...
      <!-- Commit Card (Popular)-->
      <div class="bg-base-100 p-8 md:p-10 border border-t-4 border-primary shadow-2xl hover:shadow-card-hover transition-all hover:-translate-y-2 flex flex-col h-full lg:-mt-4 lg:mb-4 relative z-10 shrink-0 scale-100 lg:scale-105  snap-center">
        <div class="absolute top-0 right-0 bg-primary text-primary-content text-xs font-bold px-3 py-1 uppercase tracking-wider font-sans">Most Popular</div>
        
        <div class="mb-8">
          <h3 class="font-anton text-4xl md:text-5xl uppercase text-primary mb-2">COMMIT</h3>
