<template>
    <section id="food" class="py-20 px-6 md:px-12 lg:px-20 xl:px-30 bg-bg-secondary overflow-hidden">
        <div class="flex flex-col items-center justify-center gap-12">
            ...
            <!-- Desktop: Grid Layout -->
            <div class="flex flex-row gap-6 w-full overflow-x-auto snap-x snap-mandatory pb-12 pt-4 px-4 -mx-4 md:mx-0 md:px-0 scrollbar-hide lg:grid lg:grid-cols-3 lg:overflow-visible lg:pb-0">
                
                <div v-for="(meal, index) in meals" :key="index" class="bg-card-white shadow-card hover:shadow-card-hover transition-all hover:-translate-y-2 flex flex-col min-w-[300px] md:min-w-[350px] lg:min-w-0 snap-center group relative h-full border border-gray-100 hover:border-primary">
                    <!-- Image Area Wrapper -->
                    <div class="relative">
                        <div class="relative h-64 overflow-hidden">
                            ...
                            <!-- Calories Badge -->
                            <div class="absolute top-0 right-0 bg-primary text-white font-anton text-lg uppercase px-4 py-2">
                                {{ meal.calories }} KCAL
                            </div>
                        </div>
                    ...
                    <div class="p-6 pt-10 flex flex-col gap-4 bg-white grow ">
                        ...
                        <!-- Macros -->
                        <div class="grid grid-cols-3 gap-px bg-gray-200 border border-gray-200 mt-auto">
                            <!-- Protein - No Delay -->
                            <div class="relative overflow-hidden bg-blue-50 py-2 px-1 text-center">
                                ...
                                <div class="relative z-10">
                                    ...
                                    <span class="block text-xs text-gray-600 group-hover:text-white/80 transition-colors duration-100 font-bold uppercase">PRO</span>
                                </div>
                            </div>
                            ...
                            <div class="relative overflow-hidden bg-blue-50 py-2 px-1 text-center">
                                ...
                                <div class="relative z-10">
                                    ...
                                    <span class="block text-xs text-gray-600 group-hover:text-white/80 transition-colors duration-100 delay-75 font-bold uppercase">CARB</span>
                                </div>
                            </div>
                            ...
                            <div class="relative overflow-hidden bg-blue-50 py-2 px-1 text-center">
                                ...
                                <div class="relative z-10">
                                    ...
                                    <span class="block text-xs text-gray-600 group-hover:text-white/80 transition-colors duration-100 delay-150 font-bold uppercase">FAT</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Blue Stripe Bottom -->
                    <div class="h-1 w-full bg-primary bg-opacity-0 group-hover:bg-opacity-100 transition-all"></div>
                </div>
             ...
             <div class="flex md:hidden flex-row w-full justify-center">
                <a href="https://wa.me/6285939533337?text=Hi%20Coach%20Yohan!%20I'd%20like%20to%20pre-order%20a%20meal%20plan.%20Can%20you%20share%20more%20details%3F" target="_blank" class="flex flex-row items-center gap-3 bg-primary px-8 py-3 text-button font-heading text-white shadow-card hover:bg-primary-hover transition-all hover-lift w-full justify-center">
                <svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 10V6a3 3 0 0 1 3-3v0a3 3 0 0 1 3 3v4m3-2 .917 11.923A1 1 0 0 1 17.92 21H6.08a1 1 0 0 1-.997-1.077L6 8h12Z"/>
                </svg>
                    PRE ORDER NOW</a>   
...
const meals = ref([
    {
        ...
        calories: 520,
        price: '95K',
        // Placeholder image - using Unsplash for reliable placeholders
