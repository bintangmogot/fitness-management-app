<template>
  <section class="bg-base-100 py-20 px-6 lg:px-20 xl:px-32 relative overflow-hidden" id="catalog-nutrition">
    ...
    <!-- <div class="absolute top-0 left-0 scale-y-[-1] w-full overflow-hidden leading-none transform z-10">
      ...
      <div class="absolute top-0 left-0 scale-y-[-1] w-full overflow-hidden leading-none transform z-10">
        <svg class="relative block w-[calc(100%+1.3px)] h-[50px] md:h-[100px]" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
          ...
          <path d="M0,120 L1200,10 L1200,120 Z" fill="#0F0F23"></path>
        </svg>
    </div>
    ...
    <div class="flex flex-col gap-20 border-2 border-primary">
      ...
      >
        ...
        <div class="w-full lg:w-1/2">
          ...
          <a :href="`https://wa.me/6285939533337?text=Hello%20Coach%20Yohan!%20I%20would%20like%20to%20order%20${encodeURIComponent(item.title)}%20for%20${encodeURIComponent(item.price + ' ' + item.priceSuffix)}.%20How%20can%20I%20place%20an%20order%3F`" target="_blank" class="w-full bg-primary text-primary-content text-center py-4 font-heading text-xl tracking-wider hover:bg-primary-focus transition-colors uppercase flex items-center justify-center gap-3">
        ...
        <!-- Image -->
        <div class="w-full lg:w-1/2 h-[25 0px] sm:h-auto bg-base-200 relative group overflow-hidden grayscale hover:grayscale-0 transition-all duration-20 items-center justify-center flex shadow-xl border-4 border-primary">
...
const items = ref([
    {
        ...
        description: 'High-grade protein designed for optimal muscle recovery immediately post-workout. Sourced locally in Bali to ensure freshness. Available in Rich Chocolate & French Vanilla.',
