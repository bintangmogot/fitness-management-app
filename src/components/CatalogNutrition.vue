    ...
    <div class="flex flex-col gap-20 border-2 border-primary">
      ...
      >
        ...
        <div class="w-full lg:w-1/2">
          ...
          <a :href="`https://wa.me/6285939533337?text=Hello%20Coach%20Yohan!%20I%20would%20like%20to%20order%20${encodeURIComponent(item.title)}%20for%20${encodeURIComponent(item.price + ' ' + item.priceSuffix)}.%20How%20can%20I%20place%20an%20order%3F`" target="_blank" class="w-full bg-primary text-white text-center py-4 font-heading text-xl tracking-wider hover:bg-primary-hover transition-colors uppercase flex items-center justify-center gap-3">
