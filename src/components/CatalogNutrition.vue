    ...
    <div class="flex flex-col gap-20 border-2 border-primary">
      ...
      >
        ...
        <div class="w-full lg:w-1/2">
          ...
          <a href="#" class="w-full bg-primary text-white text-center py-4 font-heading text-xl tracking-wider hover:bg-primary-hover transition-colors uppercase flex items-center justify-center gap-3">
